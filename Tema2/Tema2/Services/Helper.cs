...
namespace Tema2.Services
{
    public class Helper
    {
        ...
        #endregion
        #region staticValues
        public static Models.GameSquare CurrentSquare { get; set; }
        private static Dictionary<Models.GameSquare, Models.GameSquare> currentNeighbours = new Dictionary<Models.GameSquare, Models.GameSquare>();
        ...
        public static Dictionary<Models.GameSquare, Models.GameSquare> CurrentNeighbours
        {
            get
            {
        ...
        public static ObservableCollection<ObservableCollection<Models.GameSquare>> initBoard()
        {
            ObservableCollection<ObservableCollection<Models.GameSquare>> board = new ObservableCollection<ObservableCollection<Models.GameSquare>>();
            const int boardSize = 8;

            for (int row = 0; row < boardSize; ++row)
            {
                board.Add(new ObservableCollection<Models.GameSquare>());
                for (int column = 0; column < boardSize; ++column)
                {
                    if ((row + column) % 2 == 0)
                    {
                        board[row].Add(new Models.GameSquare(row, column, Enums.Square.Light, null));
                    }
                    else if (row < 3)
                    {
                        board[row].Add(new Models.GameSquare(row, column, Enums.Square.Dark, new Piece(PieceColor.Alb)));
                    }
                    else if (row > 4)
                    {
                        board[row].Add(new Models.GameSquare(row, column, Enums.Square.Dark, new Piece(PieceColor.Rosu)));
                    }
                    else
                    {
                        board[row].Add(new Models.GameSquare(row, column, Enums.Square.Dark, null));
                    }
                }
            }
        ...
        public static void ResetGameBoard(ObservableCollection<ObservableCollection<Models.GameSquare>> squares)
        {
        ...
        public static void initializeNeighboursToBeChecked(Models.GameSquare square, HashSet<Tuple<int, int>> neighboursToCheck)
        {
        ...
        public static void LoadGame(ObservableCollection<ObservableCollection<Models.GameSquare>> squares)
        {
        ...
        public static void SaveGame(ObservableCollection<ObservableCollection<Models.GameSquare>> squares)
        {
        ...
        public static void ResetGame(ObservableCollection<ObservableCollection<Models.GameSquare>> squares)
        {
            foreach (var square in CurrentNeighbours.Keys)
            {
                square.LegalSquareSymbol = null;
        ...
        public static void About()
        {
            ...
            string PATH = "D:\\FACULTATE\\Anul II\\Semestrul II\\MVP\\Teme\\Backup tema2 - bun, de prezentat\\Tema2\\Tema2\\Resources\\about.txt";
        ...
        {
            string PATH = "D:\\FACULTATE\\Anul II\\Semestrul II\\MVP\\Teme\\Backup tema2 - bun, de prezentat\\Tema2\\Tema2\\Resources\\gameStatistics.txt";
            using (var writer = new StreamWriter(PATH))
            {
